    ...
    public function run(): void
    {
        ...
        $documentTaskList = [
            ...
            [
                ...
                'task_user' => 'head_of_department',
                'task_position' => '-',
                'task_name' => 'รออนุมัติการคืน จากแผนกผู้ขอยืม',
            ],
            [
                'document_type' => 'it-borrow-hardware',
                'step' => 6,
                'task_user' => 'IT Department',
                'task_position' => 'IT Department',
                'task_name' => 'รอบันทึกรายละเอียดการคืน จากฝ่ายเทคโนโลยีสารสนเทศ',
            ],
            [
                'document_type' => 'it-borrow-hardware',
                'step' => 7,
