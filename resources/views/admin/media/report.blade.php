...
@section('content')
    <div class="mx-8 pb-10">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-primary text-3xl font-bold">Media Report</h1>
                <p class="text-base-content/60 text-sm">Dashboard สรุปข้อมูลเอกสารจัดซื้อ</p>
            </div>
            <div class="bg-base-100 rounded-lg p-4 shadow-md">
                <form class="flex items-end gap-3" action="{{ route('admin.media.reportlist') }}" method="GET">
                    ...
                    <a class="btn btn-ghost btn-sm border-base-content/20" href="{{ route('admin.media.reportlist') }}">
