        ...
        @elseif ($action == 'all')
            ...
            <div class="border-base-content/5 bg-base-100 mb-4 overflow-hidden rounded-lg border">
                <div class="border-base-content/5 bg-base-200/30 border-b px-4 py-3">
                    <form action="{{ route('admin.purchase.alllist') }}" method="GET">
                        <div class="flex flex-col gap-3 lg:flex-row lg:items-end">
                            <div class="form-control min-w-0 flex-1">
                                <label class="label pt-0" for="purchase-admin-search">
                                    <span class="label-text text-xs font-semibold">ค้นหา</span>
                                </label>
                                <input
                                    class="input input-bordered input-sm w-full"
                                    id="purchase-admin-search"
                                    type="search"
                                    name="search"
                                    value="{{ $search ?? '' }}"
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <button
                                    ...
                                    id="purchase-admin-filters-toggle"
                                    aria-expanded="{{ $hasAdvancedFilters ? 'true' : 'false' }}"
                                    aria-controls="purchase-admin-advanced-filters"
                                >
                                ...
                                <a class="btn btn-ghost btn-sm border-base-content/20 px-4" href="{{ route('admin.purchase.alllist') }}">
                        ...
                        <div
                            ...
                            id="purchase-admin-advanced-filters"
                        >
                        ...
                        <tr class="hover:bg-base-300 {{ $isNewJobOverdue ? 'bg-error/10' : '' }}">
                            ...
                            <td class="text-center">
                                <div class="flex flex-wrap items-center justify-center gap-2">
                                    ...
                                    @endif
                                    <a class="btn btn-outline btn-accent" href="{{ route('admin.purchase.view', ['document_id' => $document->id, 'action' => $action]) }}">ดูเอกสาร</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
